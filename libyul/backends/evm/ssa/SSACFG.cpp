...
{
public:
	SSACFGPrinter(SSACFG const& _cfg, ASTLabelRegistry const& _labels, SSACFG::BlockId _blockId, LivenessAnalysis const* _liveness):
	...
	SSACFGPrinter(SSACFG const& _cfg, ASTLabelRegistry const& _labels, size_t _functionIndex, Scope::Function const& _function, LivenessAnalysis const* _liveness):
